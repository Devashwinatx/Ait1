...
BOT_TOKEN = os.environ.get("BOT_TOKEN", "6870311779:AAEpXQWnqSdcZw0ffymKriwaPmutCOLroAQ")
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002013950517"))
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1001846921858"))
